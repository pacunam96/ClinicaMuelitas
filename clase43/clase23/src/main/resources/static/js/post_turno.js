window.addEventListener('load', function () {
    ...
    formulario.addEventListener('submit', function (event) {
       ...
       //creamos un JSON que tendrá los datos de la nueva película
        const formData = {
            odontologoId: document.querySelector('#odontologoIdPost').value,
            pacienteId: document.querySelector('#pacienteIdPost').value,
            fecha: document.querySelector('#fechaPost').value,
    ...
    function resetUploadForm(){
        document.querySelector('#odontologoIdPost').value = "";
        document.querySelector('#pacienteIdPost').value = "";
         document.querySelector('#fechaPost').value = "";
